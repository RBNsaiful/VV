        ...
        <header className="bg-light-bg dark:bg-dark-bg p-4 md:px-8 flex items-center justify-between sticky top-0 z-20 h-16 shadow-sm border-b border-gray-200 dark:border-gray-800">
            <div className="flex items-center gap-4 md:gap-8">
                <div className="flex items-center gap-2 cursor-pointer group" onClick={() => onNavigate('home')}>
                    ...
                    <h1 className="ml-1.5 text-[1.75rem] md:text-[2.1rem] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary drop-shadow-[0_2px_2px_rgba(0,0,0,0.2)] dark:drop-shadow-[0_2px_5px_rgba(124,58,237,0.3)]">
                        {appName}
                    </h1>
                </div>
                {user && (
